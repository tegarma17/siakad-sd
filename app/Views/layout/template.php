...
<body>
    ...
    <nav class="navbar navbar-expand-lg ">
        <a class="navbar-brand text-white" href="<?= base_url('dashboard'); ?>">SDN Kebun 1 Kamal</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>

        <div class="dropdown ml-auto mr-2 text-white">

            <i class="fas fa-user fa-2x"></i>
            <i class="fas fa-caret-down fa-2x ml-2" data-toggle="dropdown"></i>
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col">
                    <p>SDN Kebun 1 Kamal</p>
                    <p>Copyright SDN Kebun 1 Kamal @2021</p>
                </div>
            </div>
        </div>
    </div>
